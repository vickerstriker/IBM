...
read_tesla_revenue=pd.read_html(str(beautiful_soup))
tesla_revenue=read_tesla_revenue[1]
...
read_gme_revenue=pd.read_html(str(beautiful_soup))
gme_revenue=read_gme_revenue[1]
